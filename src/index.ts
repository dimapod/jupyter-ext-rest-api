 ...
 */
function activateHelloWorldExtension(app: JupyterFrontEnd, palette: ICommandPalette, mainMenu: IMainMenu): void {
 ...
 */
const helloWorldExtension: JupyterFrontEndPlugin<void> = {
